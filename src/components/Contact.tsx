...
export function Contact() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-night py-28 text-paper"
    >
      <div className="dot-texture pointer-events-none absolute inset-0 opacity-10" />
      <div className="pointer-events-none absolute top-0 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full blur-3xl" />
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center sm:px-10">
        ...
        >
          ...
          <p className="mt-4 text-lg font-semibold text-clay">
            봐주셔서 감사합니다 :)
          </p>
          <p className="mx-auto mt-6 max-w-md text-sm leading-relaxed text-faint">
            더 나은 사용 경험을 만들기 위해
            <br className="hidden sm:block" /> 기술은 깊게, 마음은 따뜻하게
            성장하겠습니다.
          </p>
